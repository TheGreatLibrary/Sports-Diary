...
import com.sinya.projects.sportsdiary.presentation.home.HomeScreenUiState
...
//        val trainingList = trainingRepository.getList(
//            start.toString(),
//            endExclusive.toString()
//        ) // если есть аналогичный метод
//
...
//    }
    ...
    suspend operator fun invoke(): CalendarWidgetState {
